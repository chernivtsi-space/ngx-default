...
- add or update the matching `src/i18n/<code>.json` dictionary
...
<button translate [translate]="{ ariaLabel: 'Go to homepage' }" type="button"></button>
```
...
```bash
git clone https://github.com/chernivtsi-space/ngx-default.git PROJECT_NAME
cd PROJECT_NAME
npm i
npm run start
```
